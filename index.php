<?php
$conexion = mysqli_connect('localhost', 'Dalvin', 'dalvin1356', 'waldo');
?>
<!DOCTYPE html>
<html lang="en">
...
<body id="top">
  ...
  <header class="header">
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo '<a href="#" onclick="confirmarCerrar(\'index1.php\')">' . htmlspecialchars($mostrar['name']) . '</a>';
    } else {
        echo "No se encontraron datos.";
    }
?>

<a href="#" class="cerrar-sesion" onclick="confirmarCerrar()">
        <i class="fas fa-arrow-alt-circle-down"></i> <!-- Icono de flecha hacia abajo de Font Awesome -->
    </a>

    <script>
        function confirmarCerrar() {
            if (confirm("¿Deseas cerrar sesión?")) {
                // Aquí puedes colocar la lógica para cerrar sesión, por ejemplo, redirigir a la página de inicio de sesión.
                alert("Sesión cerrada exitosamente."); // Mensaje de ejemplo
            } else {
                // No hace nada si se hace clic en "Cancelar"
            }
        }
    </script>
...
<script>
    function confirmarCerrar(url) {
        if (confirm("¿Deseas cerrar sesión?")) {
            window.location.href = url; // Redirige a la URL especificada si se hace clic en "Sí"
        } else {
            // No hace nada si se hace clic en "No"
        }
    }
</script>
              </a>
      ...
      <div class="container">
        ...
        <nav class="navbar container" data-navbar>
          <ul class="navbar-list">
            ...
            <li class="navbar-item">
              <a href="#prices" class="navbar-link" data-nav-link>Precios</a>
            </li>
            ...
            <li class="navbar-item">
                <a href="./assets/paginas/Carrito/index.php" class="navbar-link">Mi Carrito</a>
            </li>
          </ul>
        </nav>
